...
| G7  | Images are placeholders — pick any _relevant_ image; Rizwan/Imran finalize color/combos later. Vectors must be **high-quality**, bought if needed (billion-$ investor audience). | Meeting 00:21–00:24     | ☐      |
...
| Email             | `info@promaxglobal.ae` ⚠️ _confirm before writing_  | —       | Confirm w/ client, then add | ☐      |
| Phone             | `+971 56 601 0848` (tel:+971566010848) ⚠️ _confirm_ | —       | Confirm, add                | ☐      |
...
- Sub / body: _"We support governments, regulators, Port Authorities, Energy Transition stakeholders and industry leaders with integrated, future-ready capabilities that strengthen national competitiveness and long-term economic resilience"_
...
## 4. Section 2 — CORPORATE OVERVIEW _(NOT "Company Overview")_

**Required (verbatim heading):** **Corporate Overview** · subhead _Proudly Headquartered in Abu Dhabi_ / _Inspired by the UAE. Connected to the World._
...
## 5. Strategic Business Platforms _(replaces "What We Do" service cards)_
...
- **6** Strategic Platforms _(doc said 8 → meeting corrected to 6)_
- **5** Core Portfolios _(doc said "Core Verticals" → meeting: "5 core portfolios")_
...
## 7. Portfolios grid _(was "Global Division")_
...
| Tagline block       | _"Rooted in the UAE's spirit of innovation. We transform bold local ideas into global realities, delivering future-forward solutions from the heart of the Middle East."_ | ☐      |
...
- [ ] Hero globe: continent borders + contrast dots (or fallback video) — _client will decide visual later_
...
> **Next matrices to build (later files):** About Us · Portfolio/Ports & Logistics (Management / Advisory / Infrastructure→removed / Strategic Equipment) · Skills & Education · Smart & Green Energy · Trade Hub (Coming Soon) · AI & Fintech (Coming Soon) · Infrastructure & Asset Holdings · Strategic Projects · Why Us · Insights · Reach Us (Work / Invest / Partner forms).
